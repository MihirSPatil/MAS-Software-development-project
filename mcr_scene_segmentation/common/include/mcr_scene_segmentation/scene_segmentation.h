...
public:
    ...
    PointCloud::Ptr getPlane(const PointCloud::ConstPtr &cloud);
    PointCloud::Ptr getBoxes(const PointCloud::ConstPtr &cloud, PointCloud::ConstPtr &plane_cloud, std::vector<PointCloud::Ptr> &clusters,std::vector<BoundingBox> &boxes);

    void getCircleParams(const PointCloud::Ptr circle_cloud, double &radius, double &center_x, double &center_y);
