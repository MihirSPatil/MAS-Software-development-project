...
class PDDLProbGenCost
{
    ...
    private:
        ...
        std::map<std::string, float> probabilities_actions_;
        std::map<std::string, float> probabilities_objects_;
        std::map<std::string, float> probabilities_locations_;

        float getProbability(std::string str, std::map<std::string, float>& probabilities);
        float getProbabilityAction(std::string str);
        float getProbabilityObject(std::string str);
        float getProbabilityLocation(std::string str);
        void addProbabilityObject(std::string str, float f);

        struct goal_sort_ {
            inline bool operator()(const std::pair<float, std::string>& a, const std::pair<float, std::string>& b) {
