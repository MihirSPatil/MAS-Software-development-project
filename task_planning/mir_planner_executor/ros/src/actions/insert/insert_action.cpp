...
InsertAction::InsertAction() : client_("/insert_object_server") {
    //client_.waitForServer();
}
bool InsertAction::run(std::string& robot, std::string& platform, std::string& location, std::string& peg, std::string& hole) {
