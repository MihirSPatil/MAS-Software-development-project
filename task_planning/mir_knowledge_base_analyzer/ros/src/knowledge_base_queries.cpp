...

{
    ...
    objects_at_location_pub_ = nh_.advertise<mir_knowledge_base_analyzer::ObjectsAtLocation>("objects_at_location", 1);
...
bool KnowledgeBaseQueries::publishObjectsAtLocation(const std::string &location)
{
    ...
    {
        mir_knowledge_base_analyzer::ObjectsAtLocation objects_msg;
